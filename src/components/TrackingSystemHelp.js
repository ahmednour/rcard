...
const TrackingSystemHelp = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `يتم تخزين البيانات بشكل آمن على خوادمنا.
      جميع البيانات المجمعة مجهولة المصدر ولا تحتوي على معلومات شخصية تعريفية.
      نحن لا نشارك هذه البيانات مع أي أطراف خارجية.`,
    },
    {
      id: "milestones",
